...
const externalLinks = [
    ...
    { name: 'Download Resume', href: 'https://drive.google.com/file/d/1J6Zc9gFuEe2N7s46Eh8_q1K8oxJmEMP-/view?usp=sharing', icon: <TbFileCv size={60} className="text-purple-400" />, download: 'Ujjwal_Pandey_CV.pdf' }, 
